...
<body>
	<article class="page-box">
		<ul class="page-body">
			...
			<li class="page-item"><a href="${rootPath}/search?cat=${cat}&search=${search}&currentPageNo=${PAGE.prePageNo}"
				class="page-link">&lt;</a>
			...
			<li class="page-item"><a
				href="${rootPath}/search?cat=${cat}&search=${search}&currentPageNo=${PAGE.nextPage}"
				class="page-link">&gt;</a>
			<li class="page-item"><a
				href="${rootPath}/search?cat=${cat}&search=${search}&currentPageNo=${PAGE.finalPageNo}"
				class="page-link">[끝]</a>
		</ul>
	</article>
</body>
