...
<link rel="stylesheet" href="${rootPath}/css/pro-main.css?ver=201912230-003">
<script>
	var rootPath = "${rootPath}"
	var bStart = 0
</script>
<script src="${rootPath}/js/pro-main.js?ver=20191223"></script>
</head>
<body>
			...
			<section class="col-lg-4 col-md-5 col-sm-11">
				...
				<form class="was-validated" method="POST"
					...
					<div class="form-group">
						...
						<input type="file" accept="image/*" class="form-controller"
							name="u_file" id="u_file">
					</div>

					<div class="form-group">
						<label>보조이미지</label> <input type="file" multiple="multiple"
							accept="image/*" class="form-controller" name="u_files"
							id="u_files">

					</div>

					<div class="form-group main-img-box">
						<img src="${rootPath}/files/noimage.png" width="40%" id="p_image">
						<div class="img-menu" >
