...
public class MemoController {
	...
	public String insert(@ModelAttribute("dto") MemoDTO dto, Model model, HttpSession httpSession) {
		...
		dto.setM_date(sd.format(date));
		dto.setM_time(sf.format(date));
		dto.setM_auth(userDTO.getU_id());
	...
	public String insert(
			@ModelAttribute("dto") MemoDTO dto, Model model, String search, SessionStatus sStatus) {
