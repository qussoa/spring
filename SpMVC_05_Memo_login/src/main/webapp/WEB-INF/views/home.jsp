...
<body>
	...
	<nav>
		...
		<li><a href="${rootPath}/">memu1</a>
		<li><a href="${rootPath}/">memu2</a>
		
		<c:if test="${userDTO eq null}">
		<li><a href="${rootPath}/member/login">login</a>
		<li><a href="${rootPath}/member/join">join</a>
		</c:if>
		<c:if test="${userDTO != null}">
		<li><a href="${rootPath}/member/logout">logout</a>
