...
public class MemoController {
	...
	public String insert(@ModelAttribute("dto") MemoDTO dto, Model model) {
		/*
		 * dto =
		 * MemoDTO.builder().m_seq(9999).m_auth("qussoa").m_date("2019-12-02")
	...
	public String insert(@ModelAttribute("dto") MemoDTO dto, Model model, String search
